...
<html lang="en">
    ...
    <body class="login" @if(env('BACKGROUND_LOGIN')) style="background:{{env('BACKGROUND_LOGIN')}} !important; min-height: 100vh;" @endif>
        ...
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content" style="margin-top:3rem; border-radius: 8px !important; box-shadow:0 .1rem 1rem .25rem rgba(0,0,0,.05)!important;">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{url('login')}}" method="post">
			{{csrf_field()}}
                <h3 class="form-title" style="color:#181c32;">Sign In</h3>
                ...
                <div class="form-actions" style="border-bottom: 0px;">
                    <button type="submit" class="btn uppercase btn-block" style="border-radius:6px !important; background: {{env('BUTTON_LOGIN')}}; color: #fff">Login</button>
                    <!--
