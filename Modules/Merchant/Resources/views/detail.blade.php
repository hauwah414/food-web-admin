...
@section('content')
    ...
    <div class="portlet card_ light bordered">
        <div class="portlet-title tabbable-line">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">{{ (($detail['merchant_status'] == 'Active' || $detail['merchant_status'] == 'Inactive') ? $sub_title: 'Vendor Candidate Detail')}}</span>
            </div>
