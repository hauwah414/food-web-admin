            ...
            <form class="form-horizontal" role="form" action="{{ url('merchant/store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control onlynumber" min="1" max="99" maxlength="2" name="fee" placeholder="Fee" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-icon right">
                        ...
                        <div class="col-md-8">
                            <input type="number" class="form-control onlynumber" min="1" max="{{$ongkos_kirim}}" name="default_ongkos_kirim" placeholder="Default Ongkos Kirim" required>
                        </div>
                    </div>
                    ...
                    <br>
                    <h3 style="text-align: center">Data Bank Account</h3>
                    <hr style="border-top: 2px dashed black;">
                    <br>
                    <div class="form-group">
                        <div class="input-icon right">
                            <label class="col-md-3 control-label">
                                Bank
                                <span class="required" aria-required="true"> * </span>
                                <i class="fa fa-question-circle tooltips" data-original-title="Pilih Bank" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-8">
                            <select name="id_bank_name" class="form-control select2-multiple" data-placeholder="Select Bank" required>
                                <option></option>
                                @if (!empty($bank))
                                    @foreach($bank as $suw)
                                        <option value="{{ $suw['id_bank_name'] }}">{{ $suw['bank_name'] }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            <label class="col-md-3 control-label">
                                Beneficiary Name
                                <span class="required" aria-required="true"> * </span>
                                <i class="fa fa-question-circle tooltips" data-original-title="Masukkan nama penerima" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            <label class="col-md-3 control-label">
                                Beneficiary Account
                                <span class="required" aria-required="true"> * </span>
                                <i class="fa fa-question-circle tooltips" data-original-title="Masukkan nomor rekening" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" class="form-control onlynumber" maxlength="30" name="beneficiary_account" required placeholder="Beneficiary Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                                Attachment
                                <span class="required" aria-required="true"> * </span>
                                <i class="fa fa-question-circle tooltips" data-original-title="Masukkan Attachment File" data-container="body"></i>
                            </label>
                        <div class="col-md-8">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="form-control uneditable-input input-fixed input-medium" data-trigger="fileinput">
                                        ...
                                        <span class="fileinput-exists"> Change </span>
                                        <input type="file" name="merchant_pic_attachment"> </span>
