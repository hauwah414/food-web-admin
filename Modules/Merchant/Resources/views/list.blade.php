                                    ...
                                    <td>
                                        @if (MyHelper::hasAccess([324, 326], $grantedFeature))
                                            <a class="btn btn-sm btn-info"
                                                href="{{ url('merchant/detail', $val['id_merchant']) }}"><i
                                    ...
                                    <td>
                                        @if ($val['merchant_status'] == 'Active')
                                            <span class="sbold badge badge-pill"
                                                style="font-size: 14px!important;height: 25px!important;background-color: #1BBC9B;padding: 5px 12px;color: #fff;">Active</span>
                                        @else
                                            <span class="sbold badge badge-pill"
                                                style="font-size: 14px!important;height: 25px!important;background-color: #BFBFBF;padding: 5px 12px;color: #fff;">{{ $val['merchant_status'] }}</span>
                                        @endif
                                    </td>
