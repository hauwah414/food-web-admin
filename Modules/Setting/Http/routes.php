...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'setting', 'namespace' => 'Modules\Setting\Http\Controllers'], function () {
    ...
    Route::any('cs', ['middleware' => 'config_control:74,75', 'uses' => 'SettingController@whatsApp']);
    ...
    Route::any('invoice', 'SettingController@invoiceSetting');
    ...
    Route::post('default_invoice', 'SettingController@defaultInvoice');
...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'sumber-dana', 'namespace' => 'Modules\Setting\Http\Controllers'], function () {
    Route::any('/', 'SumberDanaController@index');
});
