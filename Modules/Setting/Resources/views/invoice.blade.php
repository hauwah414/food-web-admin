		...
		if ((file = this.files[0])) {
			...
			image.onload = function() {
				if ((this.width == 125 && this.height == 125)) {
					...
					toastr.warning("Please check dimension of your image.");
					$("#removeTTD").trigger( "click" );
					$(this).val("");
					// $('#remove_square').click()
					// image.src = _URL.createObjectURL();

					$('#ttd_finance').val("");
					$('#ttd_finance_splash').children('img').attr('src', 'https://www.placehold.it/500x250/EFEFEF/AAAAAA&amp;text=no+image');
				...
				<div class="portlet card_ light bordered">
					<div class="portlet-title">
						<div class="caption font-blue ">
							...
							<span class="caption-subject bold uppercase">Setting Invoice</span>
						</div>
					</div>
					<div class="portlet-body">
						<form role="form" class="form-horizontal" action="{{url('setting/default_invoice')}}" method="POST" enctype="multipart/form-data">
							<div class="form-body">
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">Title Invoice
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="title_invoice" value="{{$data['title_invoice']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">Company Name
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
								...
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">Company Address
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="company_address" value="{{$data['company_address']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">URL ITS 
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="url_its" value="{{$data['url_its']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">No Telp
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="telp_its" value="{{$data['telp_its']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">Fax 
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="fax_its" value="{{$data['fax_its']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
									<label class="text-right col-md-4">Admin Finance 
										<span class="required" aria-required="true"> * </span>
									</label>
									<div class="col-md-4">
										<input type="text" class="form-control" name="admin_finance" value="{{$data['admin_finance']??''}}"required>
									</div>
								</div>
								<div class="form-group col-md-12">
										<label class="control-label col-md-4">Logo ITS
											<br>
											<span class="required" aria-required="true"> (125:125) </span>
										</label><br>
										<div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
											<div class="fileinput-preview fileinput-new thumbnail">
												@if(isset($data['logo_its']))
													<img src="{{$data['logo_its']}}" style="max-width: 250px; max-height: 250px;" alt="">
												@else
											...
											<div>
												...
												<input type="file" class="file-splash" id="field_splash" accept="image/*" name="logo_its">
												</span>
								...
								<div class="form-group col-md-12">
										<label class="control-label col-md-4">TTD Finance
											<br>
											<span class="required" aria-required="true"> (125:125) </span>
										</label><br>
										<div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
											<div class="fileinput-preview fileinput-new thumbnail">
												@if(isset($data['ttd_finance']))
													<img src="{{$data['ttd_finance']}}" style="max-width: 250px; max-height: 250px;" alt="">
												@else
													<img src="https://www.placehold.it/200x100/EFEFEF/AAAAAA&amp;text=no+image" alt="">
												@endif
											</div>
											<div class="fileinput-preview fileinput-exists thumbnail" id="ttd_finance_splash" style="max-width: 250px; max-height: 250px;"></div>
											<div>
												<span class="btn default btn-file">
												<span class="fileinput-new"> Select image </span>
												<span class="fileinput-exists"> Change </span>
												<input type="file" class="ttd-finance" id="ttd_finance" accept="image/*" name="ttd_finance">
												</span>
												<a href="javascript:;" id="removeTTD" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a>
											</div>
										</div>
									</div>
							</div>
