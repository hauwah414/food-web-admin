                ...
                <div class="form-actions">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <button type="submit" class="btn green btn_round">Submit</button>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <div class="repeat">
                                <div data-repeater-list="cards">
                                    <div data-repeater-item="" class="row" style="margin-bottom: 15px;">
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:;" data-repeater-delete="" class="btn btn_round btn-danger">
                                ...
                                <hr>
                                <a href="javascript:;" data-repeater-create="" class="btn btn-info btn_round mt-repeater-add">
                                                        ...
                                                        <div class="repeat">
                                                            <div data-repeater-list="cards" class="cardopt" data-id="{{ $value['id_dashboard_user'] }}" data-start="{{ $start }}">
                                                                ...
                                                                <div data-repeater-item="" class="row rowcard" style="margin-bottom: 15px;" data-id="{{ $card['id_dashboard_card'] }}" data-id-dash="{{ $value['id_dashboard_user'] }}">
                                                                    ...
                                                                    <div class="col-md-1">
                                                                        <a href="javascript:;" data-repeater-delete="" class="btn btn-danger btn_round">
                                                                            <i class="fa fa-close"></i>
                                                                        </a>
                                                                    </div>
                                                                </div>
