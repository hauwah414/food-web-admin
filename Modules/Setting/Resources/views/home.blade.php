		...
		if ((file = this.files[0])) {
			...
			image.onload = function() {
				if (this.width == widthImg && this.height == heightImg) {
					...
					toastr.warning("Please check dimension of your photo.");
					$('#div_background_default').children('img').attr('src', 'https://www.placehold.it/300x300/EFEFEF/AAAAAA&amp;text=no+image');
					$("#remove_fieldphoto_bg").trigger( "click" );
...
<div class="tabbable-line">
	...
	<li>
            <a href="#home-background" data-toggle="tab">Background Customer</a>
        </li>
        <li class="active">
									...
									<div class="form-group col-md-12">
											...
											<div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
												...
												<div>
													...
													<input type="file" class="file_bg" id="background_default" accept="image/*" name="default_home_image">
													</span>
													<a href="javascript:;" id="remove_fieldphoto_bg" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a>
												</div>
											</div>
										</div>
								</div>
