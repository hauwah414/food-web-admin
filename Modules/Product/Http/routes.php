...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'product', 'namespace' => 'Modules\Product\Http\Controllers'], function () {
     ...
     * product
     */
    Route::any('/spesial_price/delete/{id}', ['uses' => 'ProductController@deletePrice']);
    Route::post('/spesial_price/create', ['uses' => 'ProductController@createPrice']);
    //photos
    Route::any('/photo/delete/{id}', ['uses' => 'ProductController@deletePhotoMultiple']);
    Route::post('/photo/create', ['uses' => 'ProductController@createPhoto']);
    
    
    Route::post('/merchant', ['uses' => 'ProductController@merchant']);
    ...
    Route::get('/inactive', ['middleware' => 'feature_control:48', 'uses' => 'ProductController@listProductInactive']);
    Route::post('/inactive', ['middleware' => 'feature_control:48', 'uses' => 'ProductController@listProductInactive']);
    Route::any('/approved/{id}', ['middleware' => 'feature_control:48', 'uses' => 'ProductController@approved']);
