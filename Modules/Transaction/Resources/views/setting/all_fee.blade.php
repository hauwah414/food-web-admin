    ...
    <div class="portlet card_ light bordered">
        <div class="portlet-title tabbable-line">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="#ongkos_fee" data-toggle="tab"> Global Ongkos Kirim</a>
                </li>
                <li>
        ...
        <div class="portlet-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="ongkos_fee">
                    <form class="form-horizontal" action="{{url('transaction/setting/fee/ongkir')}}" method="post">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group">
                                <div class="input-icon right">
                                    <label class="col-md-3 control-label">
                                        Ongkos Kirim
                                        <span class="required" aria-required="true"> * </span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Ongkos kirim di hitung per kilometer. Maksimal biaya tarif perkilometer" data-container="body"></i>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp </span>
                                        <input type="number"placeholder="Insert Ongkos Kirim" class="form-control" name="default_ongkos_kirim" value="{{$ongkos}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon right">
                                    <label class="col-md-3 control-label">
                                        Ongkos Kirim Flat
                                        <span class="required" aria-required="true"> * </span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Ongkos kirim di hitung secara flat.  Maksimal biaya tarif flat" data-container="body"></i>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp </span>
                                        <input type="number" placeholder="Insert Ongkos Kirim Flat" class="form-control" name="default_ongkos_kirim_flat" value="{{$ongkos_flat}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-icon right">
                                    <label class="col-md-3 control-label">
                                        ...
                                        <span class="required" aria-required="true"> * </span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Default Ongkos kirim.  Maksimal biaya tarif" data-container="body"></i>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp </span>
                                        <input type="number" placeholder="Insert Default Ongkos Kirim" class="form-control" name="ongkos_kirim" value="{{$ongkos_kirim}}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
