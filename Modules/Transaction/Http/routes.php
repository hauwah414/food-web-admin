...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'transaction', 'namespace' => 'Modules\Transaction\Http\Controllers'], function () {
    ...
    Route::get('/setting/all-reminder', 'TransactionSettingController@settingAllReminder');
    Route::post('/setting/fee/{type}', 'TransactionSettingController@settingAllFee');
    Route::post('/setting/reminder/{type}', 'TransactionSettingController@settingAllReminder');
...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'transaction', 'namespace' => 'Modules\Transaction\Http\Controllers'], function () {
    Route::any('/', ['middleware' => 'feature_control:69', 'uses' => 'TransactionController@transactionList']);
    Route::any('/process', ['middleware' => 'feature_control:69', 'uses' => 'TransactionController@transactionListProcess']);
    Route::any('/delivery', ['middleware' => 'feature_control:69', 'uses' => 'TransactionController@transactionListDelivery']);
    Route::any('/completed', ['middleware' => 'feature_control:69', 'uses' => 'TransactionController@transactionListCompleted']);
    Route::any('/cancel', ['middleware' => 'feature_control:69', 'uses' => 'TransactionController@transactionListCancel']);
    Route::get('detail/{id}', ['middleware' => 'feature_control:70', 'uses' => 'TransactionController@transactionDetail']);
    
    Route::get('accept/{id}', ['middleware' => 'feature_control:70', 'uses' => 'TransactionController@accept']);
    Route::post('request/{id}', ['middleware' => 'feature_control:70', 'uses' => 'TransactionController@requestDelivery']);
    Route::post('reject', ['middleware' => 'feature_control:70', 'uses' => 'TransactionController@reject']);
    Route::post('confirm/{id}', ['middleware' => 'feature_control:70', 'uses' => 'TransactionController@confirm']);
    
    
    //update transaction
    Route::any('item/delete/{id}', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@itemDelete']);
    Route::any('add/item', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@addItem']);
    Route::post('update/qty', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@updateQty']);
    Route::post('update/ongkir', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@updateOngkir']);
    Route::post('update/date', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@updateDate']);
    Route::post('update/sumber-pembelian', ['middleware' => 'feature_control:70', 'uses' => 'ManagementTransactionController@updateSumber']);
    ...
    Route::group(['prefix' => 'group'], function () {
       Route::any('/', [ 'uses' => 'TransactionGroupController@transactionList']);
       Route::any('/unpaid', [ 'uses' => 'TransactionGroupController@transactionListUnpaid']);
       Route::any('/completed', [ 'uses' => 'TransactionGroupController@transactionListCompleted']);
       Route::any('/rejected', [ 'uses' => 'TransactionGroupController@transactionListRejected']);
       Route::any('/detail/{id}', [ 'uses' => 'TransactionGroupController@transactionDetail']);
    });
