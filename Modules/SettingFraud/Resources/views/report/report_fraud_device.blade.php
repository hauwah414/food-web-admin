                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.status == "success") {
                            ...
                            setTimeout(function() {
                                window.location.href = '{{ url('fraud-detection/report/device') }}';
                            }, 1000);
                        } else {
...
@section('content')
    ...
    @if (!empty($result))
        <div style="text-align: right">
            <a class="btn blue" href="{{ url('fraud-detection/report/device') }}?export-excel=1"><i
                    ...
                    <tbody>
                        @if (!empty($result))
                            @foreach ($result as $value)
                                <tr>
                                    <td><a href="{{ url('fraud-detection/report/detail/device') }}/{{ $value['device_id'] }}"
