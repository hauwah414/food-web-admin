										...
										<div class="portlet sale-summary">
											...
											<div class="portlet-body">
												<ul class="list-unstyled">
													...
													<li>
														<span class="sale-info"> Suspend
															<i class="fa fa-img-up"></i>
														</span>
														@if($profile['is_suspended']==1)
															<span class="sale-num font-blue">Yes</span>
														@else
															<span class="sale-num font-red">No</span>
														@endif
													</li>
                                                                                                        @if($profile['is_suspended']==1)
													<li>
														<span class="sale-info"> 
                                                                                                                    {{$profile['note_suspend']??null}}
														</span>
													</li>
                                                                                                        @endif
													<!-- <li>
									...
									<div id="tab_4-4" class="tab-pane">
										...
										{{ csrf_field() }}
                                            ...
                                            @if(MyHelper::hasAccess([5], $grantedFeature))
												...
												<label class="control-label col-md-12">Note Suspend</label>
												<div class="col-md-4">
													<input type="text" class="form-control" width="30%" name="note_suspend" placeholder="Note Suspend" required style="width: 91.3%;">
												</div>
