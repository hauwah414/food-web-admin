																...
																<div class="row">
																	...
																	@endforeach
                                                                                                                                        @if (isset($custom))
                                                                                                                                            @foreach($custom as $key=>$row)
                                                                                                                                                <div class="col-md-3" style="margin-bottom:5px;">
                                                                                                                                                        <span class="btn dark btn-xs btn-block btn-outline var"  style="white-space: normal" data-toggle="tooltip" title="Text will be replace '{{ $custom[$key] }}'" onClick="addWhatsappContent('{{ $custom[$key] }}', this);">{{ str_replace('_',' ',$custom[$key]) }}</span>
                                                                                                                                                </div>
                                                                                                                                            @endforeach
                                                                                                                                    @endif
																</div>
