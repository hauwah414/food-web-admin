...
<form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    Open Outlet
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Masukkan jam buka outlet" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-9">
                <input type="time" class="form-control" name="open" value="{{ $val['open'] }}" required >
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    Close Outlet
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Masukkan jam tutup outlet" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-9">
                <input type="time" class="form-control" name="close" value="{{ $val['close'] }}" required >
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    First Order
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Masukkan jam pertama pemesanan" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-9">
                <input type="time" class="form-control" name="first_order" value="{{ $val['first_order'] }}" required >
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    Last Order
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Masukkan jam terakhir pemesanan" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-9">
                <input type="time" class="form-control" name="last_order" value="{{ $val['last_order'] }}" required >
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    Fee (1%-99%)
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Skema bagi hasil yang akan diterapkan pada outlet/vendor" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-8">
                <input type="text" value="{{ $val['fee'] }}" class="form-control onlynumber" min="1" max="99" maxlength="2" name="fee" placeholder="Fee"  required>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label">Type Delivery 
                <span class="required" aria-required="true"> * </span>
                <i class="fa fa-question-circle tooltips" data-original-title="Jenis ongkos pengiriman yang di terapkan" data-container="body"></i>
            </label>
            <div class="col-md-9">
                    <div class="md-radio-inline">
                    <div class="md-radio">
                        <input type="radio" id="radio131" name="flat" class="md-radiobtn" value="default" required @if($val['flat'] == 'default') checked @endif>
                        <label for="radio131">
                            <span></span>
                            <span class="check"></span>
                            <span class="box"></span> Default </label>
                    </div>
                    <div class="md-radio">
                        <input type="radio" id="radio141" name="flat" class="md-radiobtn" value="flat" required @if($val['flat'] == 'flat') checked @endif>
                        <label for="radio141">
                            <span></span>
                            <span class="check"></span>
                            <span class="box"></span> Flat </label>
                    </div>
                    <div class="md-radio">
                        <input type="radio" id="radio161" name="flat" class="md-radiobtn" value="dinamis" required @if($val['flat'] == 'dinamis') checked @endif>
                        <label for="radio161">
                            <span></span>
                            <span class="check"></span>
                            <span class="box"></span> Perkilometer </label>
                    </div>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon right">
                <label class="col-md-3 control-label">
                    ...
                    <span class="required" aria-required="true"> * </span>
                    <i class="fa fa-question-circle tooltips" data-original-title="Default ongkos kirim (1 - {{$ongkos_kirim}})" data-container="body"></i>
                </label>
            </div>
            <div class="col-md-9">
                <input type="number" class="form-control onlynumber" min="1" max="{{$ongkos_kirim}}" name="default_ongkos_kirim" value="{{$val['default_ongkos_kirim']}}" placeholder="Default Ongkos Kirim" required>
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon right">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control latlong" name="outlet_latitude" value="{{ $val['outlet_latitude'] }}" id="lat" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control latlong" name="outlet_longitude" value="{{ $val['outlet_longitude'] }}" id="lng" required>
            </div>
        </div>
