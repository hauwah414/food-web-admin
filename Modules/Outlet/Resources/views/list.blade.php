...
@section('content')
    ...
    <div class="portlet card_ light bordered">
        <div class="portlet-title" style="margin-top: 1rem;">
            <div class="caption">
                    ...
                    @if (!empty($outlet))
                        @foreach($outlet as $value)
                            <tr>
                                ...
                                <td>{{ $value['outlet_phone'] }}</td>
                                <td>{{ $value['outlet_email']}}</td>
                                @if (empty($value['city']))
                                    <td> - </td>
                                @else
                                    <td>{{ $value['city']['city_name'] }}</td>
                                @endif
                                <td>{{ $value['merchant']['merchant_pic_name']??null}}</td>
                                <td>{{ $value['merchant']['merchant_pic_id_card_number']??null}}</td>
                                <td>{{ $value['merchant']['merchant_pic_email']??null}}</td>
                                <td>{{ $value['merchant']['merchant_pic_phone']??null}}</td>
                                <td>
