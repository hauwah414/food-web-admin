...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'outlet', 'namespace' => 'Modules\Outlet\Http\Controllers'], function () {
    ...
    Route::any('data-legalitas', [ 'uses' => 'OutletController@dataLegalitas']);
    Route::any('delivery/create', [ 'uses' => 'OutletController@createOngkir']);
    Route::any('delivery/delete/{id}', [ 'uses' => 'OutletController@deleteOngkir']);
